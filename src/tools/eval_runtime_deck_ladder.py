"""Hydra entry point for Kaggle-like runtime deck ladder evaluation.

Run with:
    PYTHONPATH=data/sample_submission:src python src/tools/eval_runtime_deck_ladder.py
"""
...
def main(hydra_config: DictConfig) -> None:
    """Run configured Kaggle-like runtime deck ladder evaluation."""
